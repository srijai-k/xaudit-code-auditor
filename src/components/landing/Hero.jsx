            ...
            <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
                <div className="reveal">
                    ...
                    <h1 className="text-6xl md:text-8xl font-bold tracking-tighter leading-[0.9] mb-8">
                        CODE<br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500">CHECKER</span>
                    </h1>
                    <p className="text-xl text-gray-400 max-w-lg mb-10 leading-relaxed">
                        A client-side static checker for a defined set of JavaScript, TypeScript, React/JSX, and HTML patterns — unsanitized HTML sinks, dynamic code execution, hardcoded secrets, and a narrow SQL-injection heuristic. Findings are patterns that need human review, not proof of a vulnerability.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <button
                            ...
                            <span>SEE SUPPORTED CHECKS</span>
                        </button>
                    </div>
                ...
                <div className="reveal relative">
                    ...
                    <div className="relative bg-black border border-white/20 p-6 clip-hero-image shadow-2xl shadow-white/5">
                        ...
                        <div className="flex items-center justify-between mb-4 border-b border-white/10 pb-4">
                            ...
                            <div className="font-mono text-xs text-gray-500">example finding — not a live scan</div>
                        </div>

                        <div className="font-mono text-sm space-y-2 h-[400px] overflow-hidden relative">
                            <div className="text-gray-400">$ paste your own code into the checker →</div>
                            <div className="text-gray-500">// example input:</div>
                            <div className="pl-4 border-l border-gray-800 my-4 space-y-1 text-xs text-gray-500">
                                <div>el.innerHTML = user.bio;</div>
                            </div>

                            <div className="bg-orange-500/10 border-l-2 border-orange-500 p-2 my-2">
                                <div className="text-orange-400 font-bold flex items-center gap-2">
                                    ...
                                    HIGH — Unsanitized assignment to .innerHTML
                                </div>
                                <div className="text-gray-300 mt-1">The value assigned is not a static string literal, so it cannot be confirmed safe from this syntax alone.</div>
                                <div className="text-gray-500 mt-1">Safer example: use .textContent, or sanitize first with DOMPurify.sanitize().</div>
                            </div>

                            <div className="text-white mt-4">
                                <span className="text-yellow-400">Note:</span> this is a pattern match that needs review — not a confirmed vulnerability.
                            </div>
