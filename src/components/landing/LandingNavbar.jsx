        ...
        <nav className="fixed w-full z-50 backdrop-blur-md bg-black/50 border-b border-white/10">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    {/* Logo Image */}
                    <img src={logoXa} alt="XA Logo" className="w-10 h-10 object-contain mix-blend-screen" />
                ...
                <div className="flex items-center gap-4">
                    <a href="#" className="hidden md:block text-sm font-medium hover:text-gray-300">SIGN IN</a>
                    <button
